...
cl /EHsc src\*.c /I "../dep/include/" /I "../sketchengine/src/" sketchengine.lib OpenGL32.lib SDL2.lib SDL2main.lib glew32.lib /MT /Zi /link /OUT:bin\testbed.exe /LIBPATH:"../dep/lib"
del *.obj
IF %ERRORLEVEL% NEQ 0 (echo Error:%ERRORLEVEL% && exit)
